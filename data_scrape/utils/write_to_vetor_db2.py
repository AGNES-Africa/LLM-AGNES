...
def write_to_vector(blob_container_name, blob_connection_string):
    ...
    for blob in container_client.list_blobs():
        if (blob.name.endswith('.txt') and ("staging_unfccc-decisions" in blob.name)):
            ...
            if normalised_name not in processed_blobs:
                ...
                cursor.execute(
                    "INSERT INTO embed.llm_documents2 (id, title, title_vector, url, created_date) VALUES (%s, %s, %s, %s, %s)",
                    (
                        count, 
                        summary[0:250], 
                ...
                for document in documents:
                    ...
                    if(len(raw_text) > 0):
                        ...
                        for chunk in chunks:
                            ...
                            cursor.execute(
                                "INSERT INTO embed.document_embeddings2 (vector, content, document_id) VALUES (%s, %s, %s)",
