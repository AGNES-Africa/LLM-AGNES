...
export function ChatWindowFr(props: {
  endpoint: string,
    ...
    <div className={`mb-10 flex flex-col items-center p-4 md:p-8 rounded grow overflow-hidden ${(messages.length > 0 ? "border" : "")}`}>
      ...
      <form onSubmit={sendMessage} className="flex w-full flex-col">
        ...
        <div className="flex flex-col sm:flex-row w-full mt-4 sm:mt-6">
          ...
          <button 
            type="submit"
            title="Appuyez sur ce bouton pour poser une question à l'IA"
            ...
            <span className={(chatEndpointIsLoading || intermediateStepsLoading) ? "hidden" : "askai"}>Demander à l'IA</span>
          </button>
        </div>
      </form>
      <ToastContainer/>
